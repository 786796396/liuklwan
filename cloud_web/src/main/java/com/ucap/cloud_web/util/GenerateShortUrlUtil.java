...
public class GenerateShortUrlUtil {
	 ...
	 * @时间:2017-4-14下午2:30:43 
	 * @param url 长链接
	 * @param domainUrl 域名
	 * @return  四个短地址数组，取任意一个即可
	 */
    public static String getShortUrl(String url,String domainUrl) {
...
//        return domainUrl+"/"+twoResUrl+"/"+resUrl[0];
        return resUrl[0];
    }
...
//    	YN7ZZ3
//    	E7jEri
        String sLongUrl = "http://ftjxw.bjft.gov.cn/jxdt/gzdt/"; 
        String aResult = getShortUrl(sLongUrl,"https://jgtest.kaipuyun.cn");
        System.out.println("短连接="+aResult);
...
//        ZNBrEz
        ...
        //根据短链接获得key值
        String key = getShortKey("http://www.cnblogs.com/rA7BRr");
