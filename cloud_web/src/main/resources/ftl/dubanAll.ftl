                ...
                <tr>
                	<td>
                    	<table cellpadding="0" cellspacing="0" width="100%" height="71" style=" border-top:5px solid #ff0303; border-bottom:1px solid #d4d6db;">
                        	<tr>
                                <td style="padding-left:26px;"><a href="http://www.boxpro.cn/"><img alt="logo" src="https://www.kaipuyun.cn/images/mail/jg_logo.png"/></a></td>
                            </tr>
                        </table> 
                    </td>
                </tr>
                <tr>
                	<td>
                    	<table cellpadding="0" cellspacing="0" width="592" style="margin:0px auto 23px;">
                            <tr>
                            	<td style="padding:29px 0px 3px 0px; font-size:18px; color:#383b4d; font-family:'微软雅黑';">${siteName}官网负责人您好：</td>
                            </tr>
                            <tr>
                                <td style="padding:15px 10px 10px 40px; color:#696c7e; FONT-SIZE: 14px; font-family:'宋体'; line-height:28px;">
                                	<p style="margin:0px; text-indent:26px;">${director}为您所负责的网站完成了一次全面深度检测。</p>
                                	<p style="margin:0px; text-indent:26px;">收到此通知后，请进行网站整改</p>
                                </td>
                            </tr>
                        </table>
                    </td>
