(function ($, window, document, undefined) {
    ...
    function buildWalkthrough() {
            ...
            showButton("jpwNext",undefined,step.popup.style);
            showButton("jpwFinish",undefined,step.popup.style);
        }
    function showModal() {
            var options = _activeWalkthrough,
                step = options.steps[_index];
    ...
    function showButton(id, appendTo,nextStyle) {
            if ($("#" + id).length) return;
            var btn = _activeWalkthrough.buttons[id];
            appendTo = appendTo || "#tooltipInner";
            nextStyle = nextStyle||"";
            if (!btn) return;
