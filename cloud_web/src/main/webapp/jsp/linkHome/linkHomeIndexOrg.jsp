...
<div class="main-container container">
	<div class="row-fluid">
	<!--左侧导航       satrt  -->
	<c:set var="ba_index" value="202" scope="request"/>
	...
	<!--左侧导航       end  -->
       <div class="page-content paddt-27">
			<div class="row-fluid">
			           ...
			           <div class="row daily-monitor-box-m conditions">
			               <div class="conditions-content clearfix">
			                   ...
			                   <div class="fr export-box export-all">
			                       <i></i>
			                     	  <span onclick="linkHomeTableExcel()">全部导出</span>
			                   </div>
			           ...
			           <div class="data-show">
			               <table id="table-linkHomeSort" cellpadding="0" cellspacing="0" class="table">
			               <thead>
			                   <tr>
			                       ...
			                       <th class="w20p th-center" style="width:20%; text-align:center;">扫描URL总数<i class="tab_angle"></i></th>
			                       <th class="w20p th-center" style="width:20%; text-align:center;">首页不可用链接个数<i class="tab_angle"></i></th>
			                       <th class="w20p th-center" style="width:20%; text-align:center;">占比<i class="tab_angle"></i></th>
			                   </tr>
			               </thead>
			           </table>
			            <table id="table-Sum" class="table"></table>
			           <table id="table-linkHome" class="table">
			           		   <tbody id="linkHomeTbody">
			               		</tbody>
			           </table>
			           </div>
			    </div>
...
<script type="text/javascript" src="<%= path %>/js/link/link_Home_IndexOrg.js"></script> 
</body>
</html>