                ...
                <div> 
                    <div class="modal-container">
                        <div class="modal-nav-box">
                            <ul class="nav nav-pills" id="ulIds">
                                <li class="active" id="baseId">
                                    ...
                                    <div class="columninfo-body">
                                        <div id="channelList">
                                            ...
                                            <table cellpadding="0" cellspacing="0" class="dataTable">
                                            	 <thead>
									                   <tr>
									                   		<th class="w15p th-center sorting_disabled ui-state-default" style="width:5%;text-align: left;"><input type='checkbox' id='checkChannalAllId'/></th>
									                   		<th class="w15p th-center sorting_disabled ui-state-default" style="width:10%;text-align: left;">序号</th>
									                        <th class="w20p th-center sorting_disabled ui-state-default" style="width:15%;text-align: left;">名称</th>
									                        <th class="w10p th-center sorting_disabled ui-state-default" style="width:15%;text-align: left;">URL</th>
									                        <th class="w10p th-center sorting_disabled ui-state-default" style="width:10%;text-align: left;">跳转URL</th>
									                        <th class="w10p th-center sorting_disabled ui-state-default" style="width:10%;text-align: left;"><span title="栏目的最低更新频率">更新期限</span></th>
									                        <th class="w10p th-center sorting_disabled ui-state-default" style="width:10%;text-align: left;">类别</th>
									                        <th class="w10p th-center sorting_disabled ui-state-default" style="width:10%;text-align: left;">子类</th>
									                        <th class="w10p th-center sorting_disabled ui-state-default" style="width:5%;text-align: left;">监测</th>
									                        <th class="w10p th-center sorting_disabled ui-state-default" style="width:10%;text-align: left;">监测状态</th>
									                   </tr>
									               </thead>
