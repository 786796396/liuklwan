...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
  <head>
    ...
    <title>PDF.js viewer</title>
   	<link rel="stylesheet" href="<%= path %>/js/pdf/viewer.css"/>
    <script src="<%= path %>/js/pdf/compatibility.js"></script>
	<script src="<%= path %>/js/pdf/l10n.js"></script>
	<script src="<%= path %>/js/pdf/viewer.js"></script>
	<script src="<%= path %>/js/pdf/pdf.js"></script>
	<style>
		@media print {#printContainer div {page-break-after: always;page-break-inside: avoid;}}
	</style>
	<style scoped>
