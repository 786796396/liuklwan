...
<html>
  ...
  <body class="bg_f5f5f5">
					...
					<div class="row-fluid clearfix">
						<div class="span6 half-part clearfix">
							...
							<div class="txt-des">
								...
								<a onClick="freeCheckTb()" href="<%=path%>/connectionHomeDetail_index.action">立即体验&nbsp;></a>
							</div>
						</div>
						<div class="span6 half-part clearfix">
							...
							<div class="txt-des">
								...
								<b class="already-open">已开通服务</b><a href="javascript:void(0);"><span onclick="queryDatabaseInfo('一键检测','http://114.55.51.247/YjgZj/index.jsp','1');">立即体验&nbsp;></span></a>
							</div>
						</div>
					</div>
					<div class="row-fluid clearfix">
							...
							<div class="txt-des">
								...
								<c:choose>
									<c:when test="${isAdvancedContract == 1}">
										<b class="already-open" >已开通服务</b>
										<a onClick="depthLinkAllTb()" href="<%=path%>/linkAll_linkAllDetailIndex.action">立即体验&nbsp;></a>
									</c:when>
									<c:otherwise>
							...
							<div class="txt-des">
								...
								<c:choose>
									<c:when test="${isDepth == 1}">
										<b class="already-open" >已开通服务</b>
										<a onClick="depthChannelTb()" href="<%=path%>/connectionBusinessDetail_connectivity.action">立即体验&nbsp;></a>
									</c:when>
									<c:otherwise>
										<b class="click-open" onclick="openService()">点击开通</b>
									</c:otherwise>
							...
							<div class="txt-des">
								...
								<c:choose>
									<c:when test="${isCorrect == 1}">
										<b class="already-open" >已开通服务</b>
										<a onClick="depthCorrectTb()" href="<%=path%>/correctContent_index.action">立即体验&nbsp;></a>
									</c:when>
									<c:otherwise>
										<b class="click-open" onclick="openService()">点击开通</b>
									</c:otherwise>
						...
						<div class="span6 half-part clearfix">
							...
							<div class="txt-des">
								...
								<c:choose>
									<c:when test="${isAdvancedContract == 1}">
										<b class="already-open" >已开通服务</b>
										<a onClick="depthTotalTb()" href="<%=path%>/servicePeriod_servicePeriod.action?type=2">立即体验&nbsp;></a>
									</c:when>
									<c:otherwise>
										<b class="click-open" onclick="openService()">点击开通</b>
									</c:otherwise>
					...
					<div class="row-fluid clearfix">
						<div class="span6 half-part clearfix">
							...
							<div class="txt-des">
								...
								<c:choose>
									<c:when test="${sessionScope.shiroUser.isSafetyService !=0}">
										<b class="already-open" >已开通服务</b>
										<a onClick="depthSafeTb()" href="<%=path%>/monitorSilentResult_indexTB.action">立即体验&nbsp;></a>
									</c:when>
									<c:otherwise>
										<b class="click-open" onclick="openService()">点击开通</b>
									</c:otherwise>
	...
	<script type="text/javascript" src="<%=path%>/js/serviceCenterMonitor/indexTb.js"></script>
</body>
</html>