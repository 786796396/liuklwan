...
<html>
  <head>
	...
	<script language="javascript" type="text/javascript" src="<%= request.getContextPath() %>/js/map/everyProvince/everyProvince.json"></script>  
  </head>
<body>
<input id="siteId" type="hidden" value="${siteCode}">
<input id="isBigData" type="hidden">
<div class="container">
<div class="page-head">
    ...
    <div class="show-data_part fl">
       ...
       <div class="single_block area-map margt-12 clearfix" id="hiddenMap">
           ...
           <div class="fl item">
               ...
               <div class="cm_echarts_map" id="main" style="height:310px;"></div> 
           </div>
           <div class="fl">
      ...
      <div class="change-box" id="myTabContent">
        ...
        <div class="bg_block margt-12">
            <div class="every-bg Manage-system">
                <i></i>
                <div class="tip"><a target="_blank" href="https://pucha.kaipuyun.cn/boxpro/custom/pucha">全国政府网站管理系统</a></div>
            </div>
            <div class="every-bg baogt">
                <i></i>
                <div class="tip"><a target="_blank" href="http://jiucuo.kaipuyun.cn/">网站曝光台</a></div>
            </div>
            <div class="every-bg Manage-system">
                <i></i>
                <div class="tip"><a target="_blank" href="http://gongkai.kaipuyun.cn/databaseInfo/index">政府网站基本信息数据库</a></div>
                <!-- <p>guanli@mail.gd.gov.cn</p> -->
            </div>
        </div>
        <div class="wcat">
            <i class="top-line"></i>
            <h5>网站管理微信公众号</h5>
            <div>
                <img src="<%= path %>/images/customMade/wecat-img.jpg" alt=""/>
            </div>
            <p>扫一扫关注 政民互动零距离</p>
        </div>
    </div>
...
<script type="text/javascript">
	var webPath = "<%=path%>"; 
	  $('.cm_change-tab span').click(function(){
	        $('.cm_change-tab span').removeClass('active');
	        $(this).addClass('active');
	        var n=$(this).index();
	        $('.chart-content').hide();
	        $('.chart-content').eq(n).show();
	     });
</script>
