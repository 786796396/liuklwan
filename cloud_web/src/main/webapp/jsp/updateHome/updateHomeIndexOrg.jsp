...
<div class="main-container container">
	<div class="row-fluid">
	<!--左侧导航       satrt  -->
	<c:set var="ba_index" value="204" scope="request"/>
	...
	<!--左侧导航       end  -->
        <div class="page-content paddt-27">
			<div class="row-fluid">
			           ...
			           <div class="row daily-monitor-box-m conditions">
			               <div class="conditions-content clearfix">
			                   ...
			                   <div class="fr export-box export-all">
			                       <i></i>
			                     	  <span onclick="updateHomeIndexOrgTableExcel()">全部导出</span>
			                   </div>
			           ...
			           <div class="data-show">
			               <table id="table-updateHomeSort" cellpadding="0" cellspacing="0" class="table">
			               <thead>
			                   <tr>
			                       ...
			                       <th class="w30p th-center" style="width:30%;text-align: center;">更新数量<i class="tab_angle"></i></th>
			                   </tr>
			               </thead>
			           </table>
			           <table id="table-Sum" class="table"></table>
			           <table id="table-updateHome" class="table">
			           		       <tbody id="updateHomeIndexOrgTbody">
			               </tbody>
			           </table>
			           </div>
			    </div>
...
<script type="text/javascript" src="<%= path %>/js/updateHome/update_home_indexOrg.js"></script>
</body>
</html>