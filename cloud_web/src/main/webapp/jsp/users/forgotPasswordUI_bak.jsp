...
<div class="forgot_pw_container">
    ...
    <div class="forgot_pw_main forgot_pw_main1">
        ...
        <div class="input-box">
            ...
            <input type="text" id="userName" name="userName" class="login_input1 ph-input" placeholder="校验码" _pad="30">
        </div>
    ...
    <div class="forgot_pw_main forgot_pw_main2" style="display:none;">
        <div class="input-box">
            <input id="email" name="email" type="text" class="login_input1 ph-input" placeholder="邮箱" _pad="30">
        </div>
        <div id="emailError" class="error-msg" style="display:block;"></div>
        <div id="emailCaptchaDiv" class="v-code">
            <input id="emailCaptcha" name="emailCaptcha" type="text" class="login_input1 ph-input" placeholder="邮件验证码" _pad="30">
    ...
    <div class="forgot_pw_main forgot_pw_main3" style="display:none;">
    	<div class="popover-box">
            <div id="passwordDiv" class="input-box" data-content="长度为8-16个字符，区分大小写，至少包含两种类型" data-placement="right" data-toggle="popover">
                <input id="resetPassword"  type="password" class="login_input1 ph-input" placeholder="设置新密码" _pad="30" />
            </div>
        </div>
        <div id="resetPasswordDiv" class="input-box" data-content="长度为8-16个字符，区分大小写，至少包含两种类型" data-toggle="popover">
            <input id="newPassword" type="password" class="login_input1 ph-input" placeholder="重复新密码" _pad="30" />
        </div>
