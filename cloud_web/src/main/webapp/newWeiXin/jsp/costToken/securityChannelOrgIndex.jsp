...
<body>
	...
	<input type="hidden" id="checkType_id" value="${initMap.checkType}" />
	  <div class="result-set">
            ...
            <p class="clearfix">
                <span class="fl">更新不及时栏目数</span>
                <span class="fr">${initMap.securityChannel}个</span>
            </p>
            <p class="clearfix last-item">
                <span class="fl">问题站点数</span>
                <span class="fr">${initMap.securityChannelSite}个</span>
            </p>
        </div>
        </div>
        <div class="block-style">
            <div class="details-list-part">
                ...
                <div class="details-list-content" id="security_channel_org_list_id">
					<ul  id="security_channel_org_id">
	...
	<script language="javascript" type="text/javascript" src="<%= path%>/newWeiXin/js/securityChannel/securityChannelOrg.js"></script>
