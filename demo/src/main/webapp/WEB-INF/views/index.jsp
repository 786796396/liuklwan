...
<head>
	...
	<title>HTML5/CSS3图片左右切换弹性动画 - html5tricks</title>
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/h51/fonts/feather/style.css">
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/h51/css/demo.css" />
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/h51/css/component.css" />
	<script src="${pageContext.request.contextPath}/h51/js/modernizr.custom.js"></script>
</head>
<body>
<div class="container">
...
<script src="/follow.js" type="text/javascript"></script>
	...
	<section class="slider">
		<div class="slide slide--current" data-content="content-1">
			<div class="slide__mover">
				<div class="zoomer flex-center">
					<img class="zoomer__image" src="${pageContext.request.contextPath}/h51/images/iphone.png" alt="iPhone" />
					<div class="preview">
						<img src="${pageContext.request.contextPath}/h51/images/iphone-content-preview.png" alt="iPhone app preview" />
		...
		<div class="slide" data-content="content-2">
			<div class="slide__mover">
				<div class="zoomer flex-center">
					<img class="zoomer__image" src="${pageContext.request.contextPath}/h51/images/ipad.png" alt="iPad Mini" />
					<div class="preview">
						<img src="${pageContext.request.contextPath}/h51/images/ipad-content-preview.png" alt="iPad Mini app preview" />
		...
		<div class="slide" data-content="content-3">
			<div class="slide__mover">
				<div class="zoomer flex-center">
					<img class="zoomer__image" src="${pageContext.request.contextPath}/h51/images/macbook.png" alt="MacBook" />
					<div class="preview">
						<img src="${pageContext.request.contextPath}/h51/images/macbook-content-preview.jpg" alt="MacBook app preview" />
		...
		<div class="slide" data-content="content-4">
			<div class="slide__mover">
				<div class="zoomer flex-center">
					<img class="zoomer__image" src="${pageContext.request.contextPath}/h51/images/imac.png" alt="iMac" />
					<div class="preview">
						<img src="${pageContext.request.contextPath}/h51/images/imac-content-preview.jpg" alt="iMac app preview" />
		...
		<div class="slide" data-content="content-5">
			<div class="slide__mover">
				<div class="zoomer flex-center">
					<img class="zoomer__image" src="${pageContext.request.contextPath}/h51/images/apple-watch.png" alt="Apple Watch" />
					<div class="preview rounded">
						<img src="${pageContext.request.contextPath}/h51/images/apple-watch-content-preview.png" alt="Apple Watch app preview" />
	...
	<section class="content">
		<div class="content__item" id="content-1">
			<img class="content__item-img rounded-right" src="${pageContext.request.contextPath}/h51/images/iphone-content.png" alt="Apple Watch Content" />
		...
		<div class="content__item" id="content-2">
			<img class="content__item-img rounded-right" src="${pageContext.request.contextPath}/h51/images/ipad-content.jpg" alt="iPad Mini Content" />
			<div class="content__item-inner">
				<h2>The iPad Mini</h2>
		...
		<div class="content__item" id="content-3">
			<img class="content__item-img rounded-right" src="${pageContext.request.contextPath}/h51/images/macbook-content.jpg" alt="MacBook Content" />
			<div class="content__item-inner">
				<h2>The MacBook</h2>
		...
		<div class="content__item" id="content-4">
			<img class="content__item-img rounded-right" src="${pageContext.request.contextPath}/h51/images/imac-content.jpg" alt="iMac Content" />
			<div class="content__item-inner">
				<h2>The iMac</h2>
		...
		<div class="content__item" id="content-5">
			<img class="content__item-img rounded-right" src="${pageContext.request.contextPath}/h51/images/apple-watch-content.png" alt="Apple Watch Content" />
			<div class="content__item-inner">
...
<script src="${pageContext.request.contextPath}/h51/js/classie.js"></script>
<script src="${pageContext.request.contextPath}/h51/js/dynamics.min.js"></script>
<script src="${pageContext.request.contextPath}/h51/js/main.js"></script>
